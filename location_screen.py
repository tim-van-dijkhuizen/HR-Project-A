...
class LocationScreen(Screen):
    ...
    def getSubModules(self):
        return [
            ...
            [ LocationButton, { 'x': 803 + self.buttonOffset, 'y': 282, 'maxPlayers': 6, 'location': 46 } ],
            [ LocationButton, { 'x': 818 + self.buttonOffset, 'y': 255, 'maxPlayers': 6, 'location': 47 } ], 
            ...
            [ LocationButton, { 'x': 818 + self.buttonOffset, 'y': 368, 'maxPlayers': 6, 'location': 65 } ],
            [ LocationButton, { 'x': 802 + self.buttonOffset, 'y': 342, 'maxPlayers': 6, 'location': 66 } ],
            
    
            [ LocationButton, { 'x': 735 + 142, 'y': 350, 'maxPlayers': 6, 'location': 67 } ],
            [ LocationButton, { 'x': 705 + 142, 'y': 375, 'maxPlayers': 6, 'location': 68 } ],
            [ LocationButton, { 'x': 678 + 142, 'y': 390, 'maxPlayers': 6, 'location': 69} ],
            [ LocationButton, { 'x': 655 + 145, 'y': 415, 'maxPlayers': 6, 'location': 70 } ],
            [ LocationButton, { 'x': 635 + 145, 'y': 440, 'maxPlayers': 6, 'location': 71} ],
            [ LocationButton, { 'x': 615 + 142, 'y': 466, 'maxPlayers': 6, 'location': 72 } ],
            [ LocationButton, { 'x': 615 + 142, 'y': 494, 'maxPlayers': 6, 'location': 73 } ],
            [ LocationButton, { 'x': 628 + 142, 'y': 525, 'maxPlayers': 6, 'location': 74 } ],
            [ LocationButton, { 'x': 658 + 145, 'y': 540, 'maxPlayers': 6, 'location': 75 } ],
            [ LocationButton, { 'x': 688 + 145, 'y': 550, 'maxPlayers': 6, 'location': 76 } ],
            [ LocationButton, { 'x': 715 + 145, 'y': 535, 'maxPlayers': 6, 'location': 77 } ],
            [ LocationButton, { 'x': 735 + 145, 'y': 510, 'maxPlayers': 6, 'location': 78 } ],
            [ LocationButton, { 'x': 750 + 145, 'y': 535, 'maxPlayers': 6, 'location': 79 } ],
            [ LocationButton, { 'x': 780 + 145, 'y': 550, 'maxPlayers': 6, 'location': 80 } ],
            [ LocationButton, { 'x': 810 + 145, 'y': 540, 'maxPlayers': 6, 'location': 81 } ],
            [ LocationButton, { 'x': 838 + 145, 'y': 525, 'maxPlayers': 6, 'location': 82 } ],
            [ LocationButton, { 'x': 852 + 145, 'y': 494, 'maxPlayers': 6, 'location': 83 } ],
            [ LocationButton, { 'x': 852 + 145, 'y': 466, 'maxPlayers': 6, 'location': 84 } ],
            [ LocationButton, { 'x': 830 + 145, 'y': 440, 'maxPlayers': 6, 'location': 85 } ],
            [ LocationButton, { 'x': 810 + 145, 'y': 415, 'maxPlayers': 6, 'location': 86 } ],
            [ LocationButton, { 'x': 791 + 145, 'y': 390, 'maxPlayers': 6, 'location': 87 } ],
            [ LocationButton, { 'x': 765 + 145, 'y': 375, 'maxPlayers': 6, 'location': 88 } ],
            
            [ LocationButton, { 'x': 735 - 145, 'y': 350, 'maxPlayers': 6, 'location': 89 } ],
            [ LocationButton, { 'x': 705 - 145, 'y': 375, 'maxPlayers': 6, 'location': 90 } ],
            [ LocationButton, { 'x': 678 - 145, 'y': 390, 'maxPlayers': 6, 'location': 91 } ],
            [ LocationButton, { 'x': 655 - 145, 'y': 415, 'maxPlayers': 6, 'location': 92 } ],
            [ LocationButton, { 'x': 635 - 145, 'y': 440, 'maxPlayers': 6, 'location': 93} ],
            [ LocationButton, { 'x': 615 - 145, 'y': 466, 'maxPlayers': 6, 'location': 94 } ],
            [ LocationButton, { 'x': 615 - 145, 'y': 494, 'maxPlayers': 6, 'location': 95 } ],
            ...
            [ LocationButton, { 'x': 715 - 145, 'y': 535, 'maxPlayers': 6, 'location': 99 } ],
            [ LocationButton, { 'x': 735 - 145, 'y': 510, 'maxPlayers': 6, 'location': 100 } ],
            [ LocationButton, { 'x': 750 - 145, 'y': 535, 'maxPlayers': 6, 'location': 101 } ],
            [ LocationButton, { 'x': 780 - 145, 'y': 550, 'maxPlayers': 6, 'location': 102 } ],
            [ LocationButton, { 'x': 810 - 145, 'y': 540, 'maxPlayers': 6, 'location': 103 } ],
            [ LocationButton, { 'x': 838 - 145, 'y': 525, 'maxPlayers': 6, 'location': 104 } ],
            [ LocationButton, { 'x': 852 - 145, 'y': 494, 'maxPlayers': 6, 'location': 105 } ],
            [ LocationButton, { 'x': 852 - 145, 'y': 466, 'maxPlayers': 6, 'location': 106 } ],
            [ LocationButton, { 'x': 830 - 145, 'y': 440, 'maxPlayers': 6, 'location': 107 } ],
            [ LocationButton, { 'x': 810 - 145, 'y': 415, 'maxPlayers': 6, 'location': 108 } ],
            [ LocationButton, { 'x': 791 - 145, 'y': 390, 'maxPlayers': 6, 'location': 109 } ],
            [ LocationButton, { 'x': 765 - 145, 'y': 375, 'maxPlayers': 6, 'location': 110 } ],
            
            [ LocationButton, { 'x': 692 - self.buttonOffset, 'y': 312, 'maxPlayers': 6, 'location': 111 } ],
            [ LocationButton, { 'x': 669 - self.buttonOffset, 'y': 342, 'maxPlayers': 6, 'location': 112 } ],
            [ LocationButton, { 'x': 652 - self.buttonOffset, 'y': 368, 'maxPlayers': 6, 'location': 113 } ],
            [ LocationButton, { 'x': 630 - self.buttonOffset, 'y': 389, 'maxPlayers': 6, 'location': 114 } ],
            [ LocationButton, { 'x': 606 - self.buttonOffset, 'y': 410, 'maxPlayers': 6, 'location': 115 } ],
            [ LocationButton, { 'x': 583 - self.buttonOffset, 'y': 432, 'maxPlayers': 6, 'location': 116 } ],
            [ LocationButton, { 'x': 553 - self.buttonOffset, 'y': 432, 'maxPlayers': 6, 'location': 117 } ],
            [ LocationButton, { 'x': 525 - self.buttonOffset, 'y': 420, 'maxPlayers': 6, 'location': 118 } ],
            [ LocationButton, { 'x': 510 - self.buttonOffset, 'y': 390, 'maxPlayers': 6, 'location': 119 } ],
            [ LocationButton, { 'x': 497 - self.buttonOffset, 'y': 360, 'maxPlayers': 6, 'location': 120 } ],
            [ LocationButton, { 'x': 512 - self.buttonOffset, 'y': 330, 'maxPlayers': 6, 'location': 121 } ],
            [ LocationButton, { 'x': 542 - self.buttonOffset, 'y': 314, 'maxPlayers': 6, 'location': 122 } ],
            [ LocationButton, { 'x': 512 - self.buttonOffset, 'y': 298, 'maxPlayers': 6, 'location': 123 } ],
            [ LocationButton, { 'x': 500 - self.buttonOffset, 'y': 267, 'maxPlayers': 6, 'location': 124 } ],
            [ LocationButton, { 'x': 512 - self.buttonOffset, 'y': 238, 'maxPlayers': 6, 'location': 125 } ],
            [ LocationButton, { 'x': 525 - self.buttonOffset, 'y': 208, 'maxPlayers': 6, 'location': 126 } ],
            [ LocationButton, { 'x': 553 - self.buttonOffset, 'y': 195, 'maxPlayers': 6, 'location': 127 } ],
            [ LocationButton, { 'x': 583 - self.buttonOffset, 'y': 195, 'maxPlayers': 6, 'location': 128 } ],
            [ LocationButton, { 'x': 606 - self.buttonOffset, 'y': 215, 'maxPlayers': 6, 'location': 129 } ],
            [ LocationButton, { 'x': 630 - self.buttonOffset, 'y': 235, 'maxPlayers': 6, 'location': 130 } ],
            [ LocationButton, { 'x': 652 - self.buttonOffset, 'y': 258, 'maxPlayers': 6, 'location': 131 } ],
            [ LocationButton, { 'x': 669 - self.buttonOffset, 'y': 282, 'maxPlayers': 6, 'location': 132 } ],
        ]
