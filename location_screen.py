...
<<<<<<< HEAD
            [ LocationButton, { 'x': 779+self.move_tiles, 'y': 312, 'maxPlayers': 6, 'location': 45 } ],
            [ LocationButton, { 'x': 803+self.move_tiles, 'y': 282, 'maxPlayers': 6, 'location': 46 } ],
            [ LocationButton, { 'x': 818+self.move_tiles, 'y': 255, 'maxPlayers': 6, 'location': 47 } ], 
            [ LocationButton, { 'x': 840+self.move_tiles, 'y': 235, 'maxPlayers': 6, 'location': 48 } ],
            [ LocationButton, { 'x': 863+self.move_tiles, 'y': 215, 'maxPlayers': 6, 'location': 49 } ], 
            [ LocationButton, { 'x': 888+self.move_tiles, 'y': 192, 'maxPlayers': 6, 'location': 50 } ],
            [ LocationButton, { 'x': 918+self.move_tiles, 'y': 192, 'maxPlayers': 6, 'location': 51 } ],
            [ LocationButton, { 'x': 948+self.move_tiles, 'y': 204, 'maxPlayers': 6, 'location': 52 } ],
            [ LocationButton, { 'x': 960+self.move_tiles, 'y': 235, 'maxPlayers': 6, 'location': 53 } ],
            [ LocationButton, { 'x': 973+self.move_tiles, 'y': 265, 'maxPlayers': 6, 'location': 54 } ],
            [ LocationButton, { 'x': 957+self.move_tiles, 'y': 295, 'maxPlayers': 6, 'location': 55 } ],
            [ LocationButton, { 'x': 930+self.move_tiles, 'y': 312, 'maxPlayers': 6, 'location': 56 } ],
            [ LocationButton, { 'x': 957+self.move_tiles, 'y': 327, 'maxPlayers': 6, 'location': 57 } ],
            [ LocationButton, { 'x': 970+self.move_tiles, 'y': 357, 'maxPlayers': 6, 'location': 58 } ],
            [ LocationButton, { 'x': 960+self.move_tiles, 'y': 387, 'maxPlayers': 6, 'location': 59 } ],
            [ LocationButton, { 'x': 945+self.move_tiles, 'y': 415, 'maxPlayers': 6, 'location': 60 } ],
            [ LocationButton, { 'x': 915+self.move_tiles, 'y': 432, 'maxPlayers': 6, 'location': 61 } ],
            [ LocationButton, { 'x': 885+self.move_tiles, 'y': 432, 'maxPlayers': 6, 'location': 62 } ],
            [ LocationButton, { 'x': 863+self.move_tiles, 'y': 410, 'maxPlayers': 6, 'location': 63 } ],
            [ LocationButton, { 'x': 840+self.move_tiles, 'y': 389, 'maxPlayers': 6, 'location': 64 } ],
            [ LocationButton, { 'x': 818+self.move_tiles, 'y': 368, 'maxPlayers': 6, 'location': 65 } ],
            [ LocationButton, { 'x': 802+self.move_tiles, 'y': 342, 'maxPlayers': 6, 'location': 66 } ],
...
=======
            ...
            [ LocationButton, { 'x': 791 + 145, 'y': 390, 'maxPlayers': 6, 'location': 88 } ],
            [ LocationButton, { 'x': 765 + 145, 'y': 375, 'maxPlayers': 6, 'location': 89 } ],
>>>>>>> b80328294dcccadb388770ed448c2d272430ff7b
