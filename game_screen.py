...
class GameScreen(Screen):
    ...
    def getSubModules(self):
        ...
        modules = [            
            ...
            [ LocationButton, { 'x': 655 - 125, 'y': 220 - self.buttonOffset2, 'maxPlayers': 6, 'location': Location(1, 4), 'readOnly': True } ],
            ...
            [ LocationButton, { 'x': 810 + 164, 'y': 101 - self.buttonOffset2, 'maxPlayers': 6, 'location': Location(2, 15), 'readOnly': True } ],
            [ LocationButton, { 'x': 838 + 164, 'y': 120 - self.buttonOffset2, 'maxPlayers': 6, 'location': Location(2, 16), 'readOnly': True } ],
            ...
            [ LocationButton, { 'x': 547 - self.buttonOffset, 'y': 333 , 'maxPlayers': 6, 'location': Location(6, 11), 'readOnly': True } ],
            [ LocationButton, { 'x': 586 - self.buttonOffset, 'y': 318 , 'maxPlayers': 6, 'location': Location(6, 12), 'readOnly': True } ],
            [ LocationButton, { 'x': 547 - self.buttonOffset, 'y': 300 , 'maxPlayers': 6, 'location': Location(6, 13), 'readOnly': True } ],
